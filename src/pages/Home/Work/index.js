              ...
              <Card className='work-card'>
                ...
                <Card.Body className='card-body'>
                  ...
                  <Card.Text>
                    ...
                    compare inventory pricing with competing products to win the
                    buy box.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className='work-card'>
                ...
                <Card.Body className='card-body'>
                  ...
                  <Card.Text>
                    ...
                    identity opportunities and pain points for the Pre-Purchase,
                    Purchase, and Post-Purchase flow.
                    <br />
                    <br />
              ...
              <Card className='work-card'>
                ...
                <Card.Body className='card-body'>
                  ...
                  <Card.Text>
                    ...
                    questionaire for activity suppliers to fill out, making sure
                    their respective offerings are adhering to Cleanliness
                    standards.
                    <br />
                    <br />
