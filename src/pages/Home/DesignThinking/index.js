...
function DesignThinking () {
  return (
    <section id='designThinking' className='DesignThinking'>
      ...
      <div className='designthinking-section'>
        <Container>
          <Row>
            <Col>
              <lord-icon
              ...
              <p className='card-description'>
                ...
                problems do they solve for their customers and how? What is
                their company culture, reputation and brand personality?
              </p>
            </Col>
            <Col>
              <lord-icon
              ...
              <p className='card-description'>
                Who are the client’s primary audiences? What are their
                personality types, web behaviours, preferred interaction
                patterns and needs? Run usability tests, develop personas and
                user journey maps to identify ideal scenarios on existing pain
                points.
              </p>
            </Col>
            <Col>
          ...
          <Row>
            <Col>
              ...
              <p className='card-description'>
                ...
                cross-platform device interfaces. Share prototypes with users
                and ask for feedback on assumptions.
              </p>
            </Col>
            <Col>
              <lord-icon
              ...
              <p className='card-description'>
                Building on-brand UI elements based on Human Interface
                Guidelines. Share high fidelity prototype with targeted users to
                get feedback and opinion.
              </p>
            </Col>
            <Col><lord-icon
                style={{ width: 140, height: 140 }}
              ...
              <h5 className='card-second-title'>Analytics & Usability Testing —</h5>
              <p className='card-description'>
              Run follow-up usability tests based on any revelations from analytics overtime, previous design assumptions, and user complaints.
              </p></Col>
          </Row>
        </Container>
      </div>
